...
import com.joseph.racingcar.ui.game.state.BackgroundState
import com.joseph.racingcar.ui.game.state.BlockersState
import com.joseph.racingcar.ui.game.state.CarState
import com.joseph.racingcar.ui.game.state.GameState
import com.joseph.racingcar.ui.models.AccelerationData
import com.joseph.racingcar.ui.models.MovementInput
import com.joseph.racingcar.ui.models.RacingResourcePack
import com.joseph.racingcar.utils.Constants
import com.joseph.racingcar.utils.Constants.CAR_MOVEMENT_SPRING_ANIMATION_STIFFNESS
import com.joseph.racingcar.utils.Constants.TICKER_ANIMATION_DURATION
...
fun RacingGameScreen(
    ...
    BoxWithConstraints(modifier = modifier) {
        ...
        LaunchedEffect(movementInput()) {
            if (movementInput() == MovementInput.Accelerometer)
                ...
                .then(
                    if (gameState.isRunning()) {
                        when (movementInput()) {
                            ...
                            MovementInput.SwipeGestures -> Modifier.detectSwipeDirection(maxWidth.value.toInt()) { swipeDirection ->
                                carState.moveWithSwipeGesture(swipeDirection)
                            }

                            MovementInput.Accelerometer -> Modifier
                        }
                    } else
                        Modifier
                )
